...
1. Куда быстрее добавить элемент в массиве(хеше) в середину или в конец?
    ...
    <details>
      <summary>Ответ</summary>
      В конец, так как для того чтобы добавить элемент в середину сначала нужно выгрузить все значения, пройтись по ним, определить порядок и затем добавить, в конец просто добавляется.
    </details>
